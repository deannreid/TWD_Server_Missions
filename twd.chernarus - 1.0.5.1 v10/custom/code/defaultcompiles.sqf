...
if (!isDedicated) then {
	...
	if (DZE_ConfigTrader) then {
		call compile preprocessFileLineNumbers "fuckingfixes\player_traderMenuConfig.sqf";
	}else{
		call compile preprocessFileLineNumbers "fuckingfixes\player_traderMenuHive.sqf";
	};
