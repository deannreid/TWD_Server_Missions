...
class CfgBuildingLoot {
	...
	class Residential : Default {
		...
		lootType[] = {
			...
			{"militaryammo", "single", 0.01},
			{"assaultrifleammo", "single", 0.01},
			{"machinegunammo", "single", 0.01},
			{"sniperriflesammo", "single", 0.01},
	...
	class Military : Default {
		...
		lootType[] = {
			...
			{"militarybackpacks", "backpacks", 0.05},
			{"", "medical", 0.03},
			{"", "generic", 0.1},
			{"", "military", 0.3},
	...
	class MilitaryIndustrial : Default {
		...
		lootType[] = {
			...
			{"ItemGPS", "weapon", 0.01},
			{"PartVRotor", "magazine", 0.01},
			{"militarybackpacks", "backpacks", 0.03},
			{"", "medical", 0.05},
			{"", "generic", 0.35},
			{"", "military", 0.07},
	...
	class MilitarySpecial : Default {
		...
		lootType[] = {
			...
			{"militarybackpacks", "backpacks", 0.04},
			{"", "medical", 0.08},
			{"", "generic", 0.3},
			{"", "military", 0.01},
	...
	class MassGrave : Default {
		...
		lootType[] = {
			...
			{"DZ_LargeGunBag_EP1", "object", 0.05},
			{"", "medical", 0.05},
			{"", "generic", 0.13},
			{"", "military", 0.01},
