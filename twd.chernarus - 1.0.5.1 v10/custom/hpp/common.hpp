...
class Life_RscShortcutButtonMain : Life_RscShortcutButton {
	...
	animTextureNormal = "Scripts\Gold_Coin_system\Gui\main\normal_ca.paa";
	animTextureDisabled = "Scripts\Gold_Coin_system\Gui\main\disabled_ca.paa";
	animTextureOver = "Scripts\Gold_Coin_system\Gui\main\over_ca.paa";
	animTextureFocused = "Scripts\Gold_Coin_system\Gui\main\focus_ca.paa";
	animTexturePressed = "Scripts\Gold_Coin_system\Gui\main\down_ca.paa";
	animTextureDefault = "Scripts\Gold_Coin_system\Gui\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class life_RscXSliderH 
{
	...
	arrowEmpty = "Scripts\Gold_Coin_system\Gui\slider\arrowEmpty_ca.paa";
	arrowFull = "Scripts\Gold_Coin_system\Gui\slider\arrowFull_ca.paa";
	border = "Scripts\Gold_Coin_system\Gui\slider\border_ca.paa";
	thumb = "Scripts\Gold_Coin_system\Gui\slider\thumb_ca.paa";
};
...
class Life_RscHTML {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "Scripts\Gold_Coin_system\Gui\arrow_left_ca.paa";
	nextPage = "Scripts\Gold_Coin_system\Gui\arrow_right_ca.paa";
	shadow = 2;
	class H1 {
		font = "Zeppelin32";
		fontBold = "Zeppelin32";
