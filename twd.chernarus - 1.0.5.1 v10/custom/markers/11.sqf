diag_log "Chernarus Locating Markers";
	...
	// Staroye
		...
		_sp20 setMarkerSize [0.5,0.5];
		_sp20  setMarkerText "Service Station";
		_sp20  = _sp20 ;
	
	// Misty Peak Highway
		_sp21  = createMarker ["_sp21 ", [8199.07, 14511.9]];
		_sp21  setMarkerType "n_maint";
