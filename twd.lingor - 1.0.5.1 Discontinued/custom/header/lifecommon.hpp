class Life_RscScrollBar
{
	...
	thumb = "custom\bank\Gold_Coin_system\Gui\thumb_ca.paa";
	arrowEmpty = "custom\bank\Gold_Coin_system\Gui\arrowEmpty_ca.paa";
	arrowFull = "custom\bank\Gold_Coin_system\Gui\arrowFull_ca.paa";
	border = "custom\bank\Gold_Coin_system\Gui\border_ca.paa";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class Life_RscTree {
	...
	expandedTexture = "custom\bank\Gold_Coin_system\Gui\expandedTexture_ca.paa";
	hiddenTexture = "custom\bank\Gold_Coin_system\Gui\hiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class Life_RscShortcutButton {
	...
	animTextureDefault = "custom\bank\Gold_Coin_system\Gui\normal_ca.paa";
	animTextureNormal = "custom\bank\Gold_Coin_system\Gui\normal_ca.paa";
	animTextureDisabled = "custom\bank\Gold_Coin_system\Gui\normal_ca.paa";
	animTextureOver = "custom\bank\Gold_Coin_system\Gui\over_ca.paa";
	animTextureFocused = "custom\bank\Gold_Coin_system\Gui\focus_ca.paa";
	animTexturePressed = "custom\bank\Gold_Coin_system\Gui\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class Life_RscShortcutButtonMain : Life_RscShortcutButton {
	...
	animTextureNormal = "custom\bank\Gold_Coin_system\Gui\main\normal_ca.paa";
	animTextureDisabled = "custom\bank\Gold_Coin_system\Gui\main\disabled_ca.paa";
	animTextureOver = "custom\bank\Gold_Coin_system\Gui\main\over_ca.paa";
	animTextureFocused = "custom\bank\Gold_Coin_system\Gui\main\focus_ca.paa";
	animTexturePressed = "custom\bank\Gold_Coin_system\Gui\main\down_ca.paa";
	animTextureDefault = "custom\bank\Gold_Coin_system\Gui\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class life_RscXSliderH 
{
	...
	arrowEmpty = "custom\bank\Gold_Coin_system\Gui\slider\arrowEmpty_ca.paa";
	arrowFull = "custom\bank\Gold_Coin_system\Gui\slider\arrowFull_ca.paa";
	border = "custom\bank\Gold_Coin_system\Gui\slider\border_ca.paa";
	thumb = "custom\bank\Gold_Coin_system\Gui\slider\thumb_ca.paa";
};
...
class Life_RscHTML {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "custom\bank\Gold_Coin_system\Gui\arrow_left_ca.paa";
	nextPage = "custom\bank\Gold_Coin_system\Gui\arrow_right_ca.paa";
	shadow = 2;
	class H1 {
		font = "Zeppelin32";
		fontBold = "Zeppelin32";
...
class Life_RscCombo {
	...
	arrowFull = "custom\bank\Gold_Coin_system\Gui\arrowFull_sca.paa";
	arrowEmpty = "custom\bank\Gold_Coin_system\Gui\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
