class VehicleColourDialog
{
	...
	class RscStructuredText_110:RscStructuredText
	{
		idc = 5703;
		text = "";
	...
	class RscShortcutButton_171:RscShortcutButton
	{
		idc=-1;
		text= "Paint";
	...
	class RscShortcutButton_170:RscShortcutButton
	{
		idc = -1;
		text = "Close";
