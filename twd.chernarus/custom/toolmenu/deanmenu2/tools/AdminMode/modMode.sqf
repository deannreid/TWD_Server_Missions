...
modToggleON =
{
	if (playerESP) then {[playerESP] execVM "custom\toolmenu\deanmenu2\tools\AdminMode\ESPplayer.sqf";};
	if (invisibility) then {[invisibility] execVM "custom\toolmenu\deanmenu2\tools\AdminMode\Invisibility.sqf";};
	if (infAmmo) then {[infAmmo] execVM "custom\toolmenu\deanmenu2\tools\AdminMode\InfiniteAmmo.sqf";};
	if (godMode) then {[godMode] execVM "custom\toolmenu\deanmenu2\tools\AdminMode\GodModePlayer.sqf";};
	if (carGodMode) then {[carGodMode] execVM "custom\toolmenu\deanmenu2\tools\AdminMode\GodModeVehicle.sqf";};
	if (grassOff) then {[grassOff] execVM "custom\toolmenu\deanmenu2\tools\AdminMode\GrassOFF.sqf";};
};
