...
//Addons	
	...
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "custom\code\fn_selfActions.sqf";		//Checks which actions for self
	...
	local_lockUnlock =			compile preprocessFileLineNumbers "custom\code\local_lockUnlock.sqf";		//When vehicle is local to unit perform locking vehicle
