Sleep 5;
F1_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 59) then {[] execVM ""custom\toolmenu\deanmenu\Eexcute.sqf"";};"];
Sleep 0.02;
F2_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 60) then {[] execVM ""custom\toolmenu\common\admintools\enhancedesp.sqf"";};"];
Sleep 0.02;
F3_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 61) then {[] execVM ""custom\toolmenu\common\admintools\Godmode.sqf"";};"];
Sleep 0.02;
F4_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 62) then {[] execVM ""custom\toolmenu\common\teleport.sqf"";};"];
Sleep 0.02;
F5_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 63) then {[] execVM ""custom\toolmenu\common\addvehicleDialog.sqf"";};"];
Sleep 0.02;
