...
*/
private ["_nearestCity","_helperColor","_objectHelper","_objectHelperDir","_objectHelperPos","_canDo", "_pos", "_cnt",
...
if (count _nearestCity > 0) exitWith { DZE_ActionInProgress = false; systemChat ("You cannot build here This is too close to a City, Town or Village!");};
