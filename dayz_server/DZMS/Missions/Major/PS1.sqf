...
//Name of the Mission
_missName = "PornStar Mission";

//DZMSFindPos loops BIS_fnc_findSafePos until it gets a valid result
_coords = call DZMSFindPos;

[nil,nil,rTitleText,"A Group of Bandits have kidnapped some Porn Stars. Save them, and they might give you something special.", "PLAIN",10] call RE;
...
[nil,nil,rTitleText,"The Porn Stars Were Saved. Too bad, Could have got some Boob.", "PLAIN",6] call RE;
diag_log text format["[DZMS]: Major PS1 Porn Mission has Ended."];
