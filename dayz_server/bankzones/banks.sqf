...
if (true) then
{
  _this = createAgent ["RU_Hooker3", [6776.0112, 2491.3359, 0.00143433], [], 0, "CAN_COLLIDE"];
  _unit_2000 = _this;
  ...
  _this addAction["Rob the Bank", "custom\bank\rob\robbank.sqf"];
};
...
if (true) then
{
  _this = createAgent ["RU_Hooker3", [10005.678, 1861.6836, 0.00143433], [], 0, "CAN_COLLIDE"];
  _unit_2100 = _this;
...
if (true) then
{
  _this = createAgent ["RU_Hooker3", [12214.157, 9731.7646, 0.00143433], [], 0, "CAN_COLLIDE"];
  _unit_2200 = _this;
...
if (true) then
{
  _this = createAgent ["RU_Hooker3", [13343.663, 5488.4917, 0.00143433], [], 0, "CAN_COLLIDE"];
  _unit_2300 = _this;
...
if (true) then
{
  _this = createAgent ["RU_Hooker3", [1008.7841, 2218.9775, 0.00143433], [], 0, "CAN_COLLIDE"];
  _unit_2400 = _this;
...
if (true) then
{
  _this = createAgent ["RU_Hooker3", [8666.5801, 6517.2212, 0.00143433], [], 0, "CAN_COLLIDE"];
  _unit_2500 = _this;
...
if (true) then
{
  _this = createAgent ["RU_Hooker3", [3653.125, 8532.1699, 0.00143433], [], 0, "CAN_COLLIDE"];
  _unit_2600 = _this;
