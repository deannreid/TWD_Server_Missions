...
//	[] call compile preprocessFileLineNumbers "\z\addons\twd_server\DZAI\init\dzai_initserver.sqf";
	ExecVM "\z\addons\twd_server\WAI\init.sqf";
	[] ExecVM "\z\addons\twd_server\DZMS\DZMSInit.sqf";
