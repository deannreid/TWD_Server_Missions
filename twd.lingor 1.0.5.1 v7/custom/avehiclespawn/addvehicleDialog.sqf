...
if (isNil "vhnlist") then
{
	...
	systemChat ('<TheWastelandDiaries>: To spawn perm vehicles you must be near a trader or you get temp banned by the AntiHack.');
...
if (PermDialogSelected > -1) then {
	...
	[_vehicle] execVM "custom\avehiclespawn\addvehicle.sqf";
};