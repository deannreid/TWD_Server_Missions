...
if (dayZ_instance == 13) then { call compile preprocessFileLineNumbers "custom\code\tavi\variables.sqf"; } else { call compile preprocessFileLineNumbers "custom\code\variables.sqf";};
