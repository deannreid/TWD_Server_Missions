...
TraderDialogLoadItemList = {
	...
	_item_list = [];
	{
		...
		if((_afile == "trade_items") or (_afile == "trade_any_bicycle") or (_afile == "trade_any_boat") or (_afile == "trade_any_vehicle") or (_afile == "trade_backpacks") or (_afile == "trade_weapons") or (_afile == "trade_items_old") or (_afile == "trade_any_bicycle_old") or (_afile == "trade_any_boat_old") or (_afile == "trade_any_vehicle_old") or (_afile == "trade_backpacks_old") or (_afile == "trade_weapons_old")) then {
...
TraderDialogShowPrices = {
    ...
    ctrlSetText [TraderDialogBuyPrice, format["%1 Dollars", _item select 2]];
	...
	*/
	...
	ctrlSetText [TraderDialogSellPrice, format["%1 Dollars ", _item select 5]];
};
