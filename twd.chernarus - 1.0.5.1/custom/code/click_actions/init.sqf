...
if(isNil "DZE_CLICK_ACTIONS_BUILD") then {
    ...
    call compile preprocessFileLineNumbers "custom\code\click_actions\config.sqf";
    player_selectSlot = compile preprocessFileLineNumbers "custom\code\click_actions\ui_selectSlot.sqf";
