...
DZE_CLICK_ACTIONS = [
    ...
    ["ItemGPS","Toggle Map Marker","execVM 'custom\code\click_actions\examples\marker.sqf';","true"],
    ["ItemMap","Toggle Map Marker","execVM 'custom\code\click_actions\examples\marker.sqf';","true"]
];