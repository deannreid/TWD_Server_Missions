...
call compile preprocessFileLineNumbers "custom\wmod\config.sqf";
call compile preprocessFileLineNumbers "custom\wmod\lib.sqf";
call compile preprocessFileLineNumbers "custom\wmod\functions.sqf";
if(isServer) exitWith {};
call compile preprocessFileLineNumbers "custom\code\click_actions\init.sqf";
