player_selectSlot = compile preprocessFileLineNumbers "custom\alccraft\ui_selectSlot.sqf";
fnc_usec_selfActions = compile preprocessFileLineNumbers "custom\alccraft\fn_selfActions.sqf"; 
