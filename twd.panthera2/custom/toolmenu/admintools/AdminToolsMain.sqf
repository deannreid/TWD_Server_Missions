_pathtotools = "custom\toolmenu\admintools\tools\";
_pathtoweapon = "custom\toolmenu\admintools\weaponkits\";
_pathtovehicles = "custom\toolmenu\admintools\vehicles\";
_pathtocrates = "custom\toolmenu\admintools\crates\";
_EXECscript1 = 'player execVM "'+_pathtotools+'%1"';
_EXECscript2 = '["%1","%2","%3"] execVM "custom\toolmenu\admintools\weaponkits\WeaponKits.sqf"';
_EXECscript3 = '["%1"] execVM "custom\toolmenu\admintools\weaponkits\BackPack.sqf"';
_EXECscript4 = 'player execVM "'+_pathtoweapon+'%1"';
_EXECscript5 = 'player execVM "'+_pathtovehicles+'%1"';
_EXECscript6 = 'player execVM "'+_pathtocrates+'%1"';

if ((getPlayerUID player) in userMaster) then { // Admins
	epochmenustart = [
	["",true],
...
[
["",true],
	["Survivor",[],"",-5,[["expression",'["Survivor2_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Hero",[],"",-5,[["expression",'["Survivor3_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Bandit",[],"",-5,[["expression",'["Bandit1_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Soldier",[],"",-5,[["expression",'["Soldier1_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Ghillie",[],"",-5,[["expression",'["Sniper1_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Special Forces",[],"",-5,[["expression",'["CZ_Special_Forces_GL_DES_EP1_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Pilot",[],"",-5,[["expression",'["Pilot_EP1_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Invisible",[],"",-5,[["expression",'["Survivor1_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["", [], "", -5, [["expression", ""]], "1", "0"],
...
[
["",true],
	["Camo",[],"",-5,[["expression",'["Camo1_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Bodyguard",[],"",-5,[["expression",'["Soldier_Bodyguard_AA12_PMC_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Officer",[],"",-5,[["expression",'["Rocket_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Alejandria",[],"",-5,[["expression",'["SurvivorWcombat_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Savannah",[],"",-5,[["expression",'["SurvivorWdesert_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Melly",[],"",-5,[["expression",'["SurvivorWpink_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Bandit Jane",[],"",-5,[["expression",'["BanditW2_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["Invisible",[],"",-5,[["expression",'["Survivor1_DZ"] execVM "custom\toolmenu\admintools\skins\Skins.sqf"']],"1","1"],
	["", [], "", -5, [["expression", ""]], "1", "0"],
		["Main Menu", [20], "#USER:epochmenustart", -5, [["expression", ""]], "1", "1"]
];
...
["BaseDestruction",true],
	["SetCenter",[],"",-5,[["expression",'["center"] execVM "custom\toolmenu\admintools\tools\deletebase.sqf"']],"1","1"],
	["SetRadius",[],"",-5,[["expression",'["radius"] execVM "custom\toolmenu\admintools\tools\deletebase.sqf"']],"1","1"],
	["ShowDome",[],"",-5,[["expression",'["dome"] execVM "custom\toolmenu\admintools\tools\deletebase.sqf"']],"1","1"],
	[format["IncludeVehicles(%1)",BD_vehicles],[],"",-5,[["expression","BD_vehicles=!BD_vehicles;"]],"1","1"],
	["DESTROY ALL Inside Dome",[],"",-5,[["expression",'["destroy"] execVM "custom\toolmenu\admintools\tools\deletebase.sqf"']],"1","1"],
		["", [], "", -5, [["expression", ""]], "1", "0"],
		["Main Menu", [20], "#USER:epochmenustart", -5, [["expression", ""]], "1", "1"]
];
VehicleTempMenu=
...
["",true],
	...
	["MH-6J Little Bird",[],"",-5,[["expression",'["MH6J_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["UH-60M Black Hawk",[],"",-5,[["expression",'["UH60M_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["CH-47F Chinook",[],"",-5,[["expression",'["CH_47F_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["MV-22 Osprey",[],"",-5,[["expression",'["MV22"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["A-10",[],"",-5,[["expression",'["A10"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["C-130J Super Hercules",[],"",-5,[["expression",'["C130J"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["",[],"",-5,[["expression",""]],"1","0"],
...
["",true],
	...
	["SUV (Camo)",[],"",-5,[["expression",'["SUV_Camo"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["Armored SUV",[],"",-5,[["expression",'["ArmoredSUV_PMC_DZE"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["MTVR (Fuel)",[],"",-5,[["expression",'["MTVR_Refuel_DES_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["Ural Truck",[],"",-5,[["expression",'["Ural_TK_CIV_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["Ikarus Bus",[],"",-5,[["expression",'["Ikarus_TK_CIV_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["HMMWV (Ambulance)",[],"",-5,[["expression",'["HMMWV_Ambulance"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["Military Offroad Special",[],"",-5,[["expression",'["LandRover_Special_CZ_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["Mountain Bike",[],"",-5,[["expression",'["MMT_USMC"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["Motorcycle",[],"",-5,[["expression",'["M1030"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["ATV",[],"",-5,[["expression",'["ATV_US_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["", [], "", -5, [["expression", ""]], "1", "0"],
...
["",true],
	...
	["M1A1",[],"",-5,[["expression",'["M1A1_US_DES_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["M1A2 TUSK",[],"",-5,[["expression",'["M1A2_US_TUSK_MG_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["M270 MLRS",[],"",-5,[["expression",'["MLRS_DES_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["T-34",[],"",-5,[["expression",'["T34_TK_EP1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["", [], "", -5, [["expression", ""]], "1", "0"],
...
["",true],
	...
	["Fishing Boat",[],"",-5,[["expression",'["Fishing_Boat"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["PBX",[],"",-5,[["expression",'["PBX"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["RHIB",[],"",-5,[["expression",'["RHIB"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["Small boat",[],"",-5,[["expression",'["Smallboat_1"] execVM "custom\toolmenu\admintools\tools\addtempvehicle.sqf"']],"1","1"],
	["", [], "", -5, [["expression", ""]], "1", "0"],
