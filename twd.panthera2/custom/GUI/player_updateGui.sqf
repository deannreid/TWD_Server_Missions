...
if (_visual > 0) then {_visualtext = "custom\GUI\val_" + str(_visual) + "_ca.paa"};
...
if (_audible > 0) then {_audibletext = "custom\GUI\val_" + str(_audible) + "_ca.paa"};
