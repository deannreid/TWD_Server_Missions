if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_roadkill_damageweapon	= 1;			// percentage of chance a roadkill will destroy weapon AI is carrying
		ai_cleanup_time 			= 1600;			// time to clear bodies in seconds

		ai_patrol_radius 			= 400;			// radius of ai patrols in meters
